...
const Main = (props: IMainProps) => {
  return (
    <div className="antialiased w-full relative">
      ...
      {/* Enhanced Footer */}
      <footer className="footer-gradient footer-pattern text-black relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/4 w-72 h-72 bg-gradient-to-r from-blue-200 to-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 floating-animation"></div>
          <div
            className="absolute bottom-0 right-1/4 w-72 h-72 bg-gradient-to-r from-purple-200 to-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 floating-animation"
        ...
        <div className="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="text-center lg:text-left ">
              ...
              />
              <h3 className="text-xl font-bold mb-4 text-gray-900">TN7 Edu</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="contact-item">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 mb-3">0763-771-191</p>
                  </div>
                </div>
                ...
                <div className="contact-item">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 mb-3">contact@tn7.vn</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3 text-gray-700">
                {props.config.footer.links.map(({ name, url }) => (
                  <Link key={name} href={url}>
                    <a className="footer-link block">{name}</a>
                  </Link>
                ))}
              </div>
                ...
                <div className="flex gap-4">
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M20 10C20 4.477 15.523 0 10 0S0 4.477 0 10c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V10h2.54V7.797c0-2.506 1.492-3.89 3.777-3.90 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V10h2.773l-.443 2.89h-2.33v6.988C16.343 19.128 20 14.991 20 10z"
                        clipRule="evenodd"
                      />
                    </svg>
                  </a>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 space-y-4 md:space-y-0">
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-600">
                © Copyright 2025 TN7 Edu. All rights reserved.
